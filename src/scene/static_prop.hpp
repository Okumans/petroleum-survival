 ...
 *
 * Static props are non-interactive environment props that serve as visual
 * clutter and environmental detail. They don't move, don't collide with
 * entities, and don't participate in combat.
 */
...
public:
   ...
   */
  StaticProp(std::shared_ptr<Model> model, glm::vec3 pos = glm::vec3(0.0f),
